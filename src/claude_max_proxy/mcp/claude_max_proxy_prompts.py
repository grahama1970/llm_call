...
This claude_max_proxy provides the standard implementation pattern for MCP prompts.
Copy this file to your project and customize for your domain.

Project: claude_max_proxy
Description: claude_max_proxy - Granger spoke module
"""

from typing import Dict, Any, List, Optional
from ..mcp.prompts import mcp_prompt, format_prompt_response, get_prompt_registry

# Replace 'claude_max_proxy' with your project name throughout this file
PROJECT_NAME = "claude_max_proxy"
PROJECT_DESCRIPTION = "claude_max_proxy - Intelligent automation for the Granger ecosystem"
