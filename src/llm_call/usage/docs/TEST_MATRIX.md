...
|---------|----------|---------|-------------|---------------|-----------------|--------------|
| F1.1 | **CRITICAL** | `llm ask "What is 2+2?" --model gpt-4o-mini` | `{"model": "gpt-4o-mini", "messages": [{"role": "user", "content": "What is 2+2?"}]}` | `/llm "What is 2+2?" --model gpt-4o-mini` | "4" or "2+2 equals 4" | Exact match |
| F1.2 | **CRITICAL** | `llm ask "Write a Python function to reverse a string" --model vertex_ai/gemini-1.5-flash` | `{"model": "vertex_ai/gemini-1.5-flash", "messages": [{"role": "user", "content": "Write a Python function to reverse a string"}]}` | `/llm "Write a Python function to reverse a string" --model vertex_ai/gemini-1.5-flash` | Valid Python function with proper syntax | Python syntax check |
| F1.3 | MODERATE | `llm ask "Define ML in one sentence" --model ollama/phi3:mini` | `{"model": "ollama/phi3:mini", "messages": [{"role": "user", "content": "Define ML in one sentence"}]}` | `/llm "Define ML in one sentence" --model ollama/phi3:mini` | Single sentence, 10-30 words | Length validation |
...
| F1.5 | **CRITICAL** | `llm ask "List 5 programming languages" --model ollama/qwen2.5:32b` | `{"model": "ollama/qwen2.5:32b", "messages": [{"role": "user", "content": "List 5 programming languages"}]}` | `/llm "List 5 programming languages" --model ollama/qwen2.5:32b` | Exactly 5 languages with descriptions | Count validation |
| F1.6 | MODERATE | `llm ask "What is the weather today?" --model perplexity/llama-3.1-sonar-small-128k-online` | `{"model": "perplexity/llama-3.1-sonar-small-128k-online", "messages": [{"role": "user", "content": "What is the weather today?"}]}` | `/llm "What is the weather today?" --model perplexity/llama-3.1-sonar-small-128k-online` | Current weather information with sources | Online data check |

### 1.2 System Prompts

| Test ID | Command | Config JSON | Slash Command | Expected Output | Verification |
|---------|---------|-------------|---------------|-----------------|--------------|
| F2.1 | `llm ask "Hello" --model ollama/codellama:13b-instruct-q8_0 --system "You speak like Shakespeare"` | `{"model": "ollama/codellama:13b-instruct-q8_0", "messages": [{"role": "system", "content": "You speak like Shakespeare"}, {"role": "user", "content": "Hello"}]}` | `/llm "Hello" --model ollama/codellama:13b-instruct-q8_0 --system "You speak like Shakespeare"` | Shakespearean greeting | Style check |
| F2.2 | `llm ask "Explain gravity" --model vertex_ai/gemini-1.5-flash --system "You are a 5-year-old"` | `{"model": "vertex_ai/gemini-1.5-flash", "messages": [{"role": "system", "content": "You are a 5-year-old"}, {"role": "user", "content": "Explain gravity"}]}` | `/llm "Explain gravity" --model vertex_ai/gemini-1.5-flash --system "You are a 5-year-old"` | Simple, childlike explanation | Readability score |
