...
### 0. READ CLAUDE.md in the project root directory
You MUST read an fully understand the rules and conventions in CLAUDE.md before you begin. NO Exceptions!
...
```
perplexity_ask: "pdf layout analysis best practices 2025 python"
...
# - "surya model optimization patterns 2025"
