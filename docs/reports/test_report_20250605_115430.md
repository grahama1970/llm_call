# Test Report - 2025-06-05 11:54:30
...
|-----------|-------------|--------|--------|----------|-----------|---------------|
| test_ask_basic | Test basic ask command. | Success | Pass | 3.586s | 2025-06-05 11:54:36 |  |
| test_ask_with_model | Test ask command with model selection. | Success | Pass | 3.359s | 2025-06-05 11:54:39 |  |
| test_ask_with_validation | Test ask command with validation. | Success | Pass | 3.501s | 2025-06-05 11:54:42 |  |
| test_ask_json_mode | Test ask command with JSON mode. | Success | Pass | 3.426s | 2025-06-05 11:54:46 |  |
| test_ask_with_system_prompt | Test ask command with system prompt. | Success | Pass | 3.524s | 2025-06-05 11:54:49 |  |
| test_ask_show_config | Test ask command with config display. | Success | Pass | 3.553s | 2025-06-05 11:54:53 |  |
| test_chat_basic | Test basic chat command. | Success | Pass | 0.005s | 2025-06-05 11:54:53 |  |
| test_chat_with_system | Test chat with system prompt. | Success | Pass | 0.004s | 2025-06-05 11:54:53 |  |
| test_call_json_config | Test call command with JSON config. | Success | Pass | 3.455s | 2025-06-05 11:54:56 |  |
| test_call_yaml_config | Test call command with YAML config. | Success | Pass | 3.199s | 2025-06-05 11:55:00 |  |
| test_call_with_overrides | Test call command with config overrides. | Success | Pass | 3.473s | 2025-06-05 11:55:03 |  |
| test_models_list_all | Test listing all models. | Success | Pass | 0.008s | 2025-06-05 11:55:03 |  |
| test_models_filter_provider | Test filtering models by provider. | Success | Pass | 0.004s | 2025-06-05 11:55:03 |  |
| test_validators_list | Test listing validation strategies. | Success | Pass | 0.010s | 2025-06-05 11:55:03 |  |
| test_config_example_json | Test generating example JSON config. | Success | Pass | 0.003s | 2025-06-05 11:55:03 |  |
| test_config_example_yaml | Test generating example YAML config. | Success | Pass | 0.005s | 2025-06-05 11:55:03 |  |
| test_generate_claude | Test Claude slash command generation. | Success | Pass | 0.008s | 2025-06-05 11:55:03 |  |
| test_generate_mcp_config | Test MCP config generation. | Success | Pass | 0.004s | 2025-06-05 11:55:03 |  |
| test_serve_mcp_help | Test serve-mcp command help. | Success | Pass | 0.007s | 2025-06-05 11:55:03 |  |
| test_test_command_no_files | Test 'test' command when no test files exist. | Success | Pass | 0.004s | 2025-06-05 11:55:03 |  |
| test_test_command_with_files | Test 'test' command with test files. | Success | Pass | 0.026s | 2025-06-05 11:55:03 |  |
| test_test_poc_help | Test test-poc command help. | Success | Pass | 0.009s | 2025-06-05 11:55:03 |  |
| test_readme_examples_exist | Test that commands mentioned in README exist in CLI. | Success | Pass | 0.009s | 2025-06-05 11:55:03 |  |
| test_readme_ask_examples | Test that README 'ask' examples work. | Success | Pass | 3.687s | 2025-06-05 11:55:07 |  |
| test_config_with_validation | Test using config file with validation. | Success | Pass | 5.979s | 2025-06-05 11:55:13 |  |
| test_generate_then_use_commands | Test generating commands and verifying they're usable. | Success | Pass | 0.014s | 2025-06-05 11:55:13 |  |
| test_call_missing_config | Test call command with missing config file. | Success | Pass | 0.004s | 2025-06-05 11:55:13 |  |
| test_call_invalid_config_format | Test call command with unsupported config format. | Success | Pass | 0.004s | 2025-06-05 11:55:13 |  |
| test_ask_invalid_model | Test handling invalid model. | Success | Pass | 3.124s | 2025-06-05 11:55:16 |  |
...
| test_all_validators_inventory | Create inventory of all available validators. | Success | Pass | 0.001s | 2025-06-05 11:55:46 |  |
...
| test_validator_edge_cases[test_case5] | Validator edge cases[case5] | Skipped | Skip | 0.000s | 2025-06-05 11:55:46 |  |
...
| test_model_parsing_in_executor | Test that model names are correctly parsed and added to CLI command. | Success | Pass | 0.019s | 2025-06-05 11:55:46 |  |
...
| test_response_format_handling | Test that response_format is preserved for max models. | Success | Pass | 0.000s | 2025-06-05 11:55:46 |  |
...
| test_max_proxy | Test max/* model through proxy. | Skipped | Skip | 0.000s | 2025-06-05 11:55:46 |  |
