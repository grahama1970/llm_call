# Test Report - 2025-05-26 11:44:45
...
|-----------|-------------|--------|--------|----------|-----------|---------------|
| test_ask_basic | Test basic ask command. | Success | Pass | 0.923s | 2025-05-26 11:44:48 |  |
| test_ask_with_model | Test ask command with model selection. | Success | Pass | 0.615s | 2025-05-26 11:44:49 |  |
| test_ask_with_validation | Test ask command with validation. | Success | Pass | 0.575s | 2025-05-26 11:44:49 |  |
| test_ask_json_mode | Test ask command with JSON mode. | Success | Pass | 0.554s | 2025-05-26 11:44:50 |  |
| test_ask_with_system_prompt | Test ask command with system prompt. | Success | Pass | 0.565s | 2025-05-26 11:44:50 |  |
| test_ask_show_config | Test ask command with config display. | Success | Pass | 0.537s | 2025-05-26 11:44:51 |  |
| test_chat_basic | Test basic chat command. | Success | Pass | 0.004s | 2025-05-26 11:44:51 |  |
| test_chat_with_system | Test chat with system prompt. | Success | Pass | 0.004s | 2025-05-26 11:44:51 |  |
| test_call_json_config | Test call command with JSON config. | Success | Pass | 0.558s | 2025-05-26 11:44:51 |  |
| test_call_yaml_config | Test call command with YAML config. | Success | Pass | 0.463s | 2025-05-26 11:44:52 |  |
| test_call_with_overrides | Test call command with config overrides. | Success | Pass | 0.441s | 2025-05-26 11:44:52 |  |
| test_models_list_all | Test listing all models. | Success | Pass | 0.007s | 2025-05-26 11:44:52 |  |
| test_models_filter_provider | Test filtering models by provider. | Success | Pass | 0.004s | 2025-05-26 11:44:52 |  |
| test_validators_list | Test listing validation strategies. | Success | Pass | 0.012s | 2025-05-26 11:44:52 |  |
| test_config_example_json | Test generating example JSON config. | Success | Pass | 0.003s | 2025-05-26 11:44:52 |  |
| test_config_example_yaml | Test generating example YAML config. | Success | Pass | 0.006s | 2025-05-26 11:44:52 |  |
| test_generate_claude | Test Claude slash command generation. | Success | Pass | 0.009s | 2025-05-26 11:44:52 |  |
| test_generate_mcp_config | Test MCP config generation. | Success | Pass | 0.004s | 2025-05-26 11:44:52 |  |
| test_serve_mcp_help | Test serve-mcp command help. | Success | Pass | 0.008s | 2025-05-26 11:44:52 |  |
| test_test_command_no_files | Test 'test' command when no test files exist. | Success | Pass | 0.003s | 2025-05-26 11:44:52 |  |
| test_test_command_with_files | Test 'test' command with test files. | Success | Pass | 0.023s | 2025-05-26 11:44:52 |  |
| test_test_poc_help | Test test-poc command help. | Success | Pass | 0.008s | 2025-05-26 11:44:52 |  |
| test_readme_examples_exist | Test that commands mentioned in README exist in CLI. | Success | Pass | 0.008s | 2025-05-26 11:44:52 |  |
| test_readme_ask_examples | Test that README 'ask' examples work. | Success | Pass | 0.488s | 2025-05-26 11:44:53 |  |
| test_config_with_validation | Test using config file with validation. | Success | Pass | 0.491s | 2025-05-26 11:44:53 |  |
| test_generate_then_use_commands | Test generating commands and verifying they're usable. | Success | Pass | 0.022s | 2025-05-26 11:44:54 |  |
| test_call_missing_config | Test call command with missing config file. | Success | Pass | 0.006s | 2025-05-26 11:44:54 |  |
| test_call_invalid_config_format | Test call command with unsupported config format. | Success | Pass | 0.006s | 2025-05-26 11:44:54 |  |
| test_ask_invalid_model | Test handling invalid model. | Success | Pass | 2.943s | 2025-05-26 11:44:56 |  |
...
| test_validation_integration | Test validation strategy integration. | Success | Pass | 0.000s | 2025-05-26 11:45:21 |  |
...
| test_json_schema_validation | Test JSON schema validation. | Success | Pass | 0.003s | 2025-05-26 11:45:21 |  |
