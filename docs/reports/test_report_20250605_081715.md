# Test Report - 2025-06-05 08:17:15
...
|-----------|-------------|--------|--------|----------|-----------|---------------|
| test_ask_basic | Test basic ask command. | Success | Pass | 3.511s | 2025-06-05 08:17:20 |  |
| test_ask_with_model | Test ask command with model selection. | Success | Pass | 3.505s | 2025-06-05 08:17:24 |  |
| test_ask_with_validation | Test ask command with validation. | Success | Pass | 3.700s | 2025-06-05 08:17:27 |  |
| test_ask_json_mode | Test ask command with JSON mode. | Success | Pass | 3.478s | 2025-06-05 08:17:31 |  |
| test_ask_with_system_prompt | Test ask command with system prompt. | Success | Pass | 3.380s | 2025-06-05 08:17:34 |  |
| test_ask_show_config | Test ask command with config display. | Success | Pass | 3.696s | 2025-06-05 08:17:38 |  |
| test_chat_basic | Test basic chat command. | Success | Pass | 0.005s | 2025-06-05 08:17:38 |  |
| test_chat_with_system | Test chat with system prompt. | Success | Pass | 0.005s | 2025-06-05 08:17:38 |  |
| test_call_json_config | Test call command with JSON config. | Success | Pass | 3.414s | 2025-06-05 08:17:41 |  |
| test_call_yaml_config | Test call command with YAML config. | Success | Pass | 3.419s | 2025-06-05 08:17:45 |  |
| test_call_with_overrides | Test call command with config overrides. | Success | Pass | 3.406s | 2025-06-05 08:17:48 |  |
| test_models_list_all | Test listing all models. | Success | Pass | 0.007s | 2025-06-05 08:17:48 |  |
| test_models_filter_provider | Test filtering models by provider. | Success | Pass | 0.004s | 2025-06-05 08:17:48 |  |
| test_validators_list | Test listing validation strategies. | Success | Pass | 0.010s | 2025-06-05 08:17:48 |  |
| test_config_example_json | Test generating example JSON config. | Success | Pass | 0.004s | 2025-06-05 08:17:48 |  |
| test_config_example_yaml | Test generating example YAML config. | Success | Pass | 0.005s | 2025-06-05 08:17:48 |  |
| test_generate_claude | Test Claude slash command generation. | Success | Pass | 0.008s | 2025-06-05 08:17:48 |  |
| test_generate_mcp_config | Test MCP config generation. | Success | Pass | 0.004s | 2025-06-05 08:17:48 |  |
| test_serve_mcp_help | Test serve-mcp command help. | Success | Pass | 0.009s | 2025-06-05 08:17:48 |  |
| test_test_command_no_files | Test 'test' command when no test files exist. | Success | Pass | 0.004s | 2025-06-05 08:17:48 |  |
| test_test_command_with_files | Test 'test' command with test files. | Success | Pass | 0.024s | 2025-06-05 08:17:48 |  |
| test_test_poc_help | Test test-poc command help. | Success | Pass | 0.007s | 2025-06-05 08:17:48 |  |
| test_readme_examples_exist | Test that commands mentioned in README exist in CLI. | Success | Pass | 0.007s | 2025-06-05 08:17:48 |  |
| test_readme_ask_examples | Test that README 'ask' examples work. | Success | Pass | 4.179s | 2025-06-05 08:17:52 |  |
| test_config_with_validation | Test using config file with validation. | Success | Pass | 3.375s | 2025-06-05 08:17:56 |  |
| test_generate_then_use_commands | Test generating commands and verifying they're usable. | Success | Pass | 0.012s | 2025-06-05 08:17:56 |  |
| test_call_missing_config | Test call command with missing config file. | Success | Pass | 0.003s | 2025-06-05 08:17:56 |  |
| test_call_invalid_config_format | Test call command with unsupported config format. | Success | Pass | 0.004s | 2025-06-05 08:17:56 |  |
| test_ask_invalid_model | Test handling invalid model. | Success | Pass | 2.866s | 2025-06-05 08:17:59 |  |
...
| test_all_validators_inventory | Create inventory of all available validators. | Success | Pass | 0.001s | 2025-06-05 08:18:29 |  |
...
| test_validator_edge_cases[test_case5] | Validator edge cases[case5] | Skipped | Skip | 0.000s | 2025-06-05 08:18:29 |  |
...
| test_model_parsing_in_executor | Test that model names are correctly parsed and added to CLI command. | Success | Pass | 0.016s | 2025-06-05 08:18:29 |  |
...
| test_response_format_handling | Test that response_format is preserved for max models. | Success | Pass | 0.000s | 2025-06-05 08:18:29 |  |
...
| test_max_proxy | Test max/* model through proxy. | Skipped | Skip | 0.000s | 2025-06-05 08:18:29 |  |
